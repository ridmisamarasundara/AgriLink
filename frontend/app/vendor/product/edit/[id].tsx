...
export default function EditProductDetailsOne() {
  const {
    id,
    name: initialName,
    unitPrice: initialPrice,
    bestBefore: initialBestBefore,
  ...
  // Update product and navigate to product details
  const updateProduct = () => {
    ...
    // 🔹 Use absolute path with query params
    router.replace(
      `/vendor/product/${id}?name=${encodeURIComponent(name)}&unitPrice=${unitPrice}&bestBefore=${encodeURIComponent(
        bestBefore
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 30 }}>
      ...
      <View style={styles.card}>
        ...
        <TextInput
          ...
          placeholder="Enter best before info"
        />
